...
export default function BalanceDetails() {
  ...
  const { data } = trpc.balance.getById.useQuery({
    ...
    <>
      ...
      <div className="flex w-full items-center">
        ...
        >
          ...
          <div className="divide-x-border-primary sticky top-0 z-10 mt-[70px] flex w-full flex-row items-center justify-items-center divide-x rounded-t-md border border-border-primary bg-black text-sm text-border-primary text-text-secondary">
            {tabs.map((tab, index) => (
              <div
                key={index}
                className={clsx(
                ...
                onClick={() => {
                  setActiveTab(index);
                  window.scrollTo({
                    top: (tab.ref.current?.offsetTop ?? 0) - 65,
                    behavior: "smooth",
                  });
                }}
              >
          ...
          <div className="w-full pt-14">
            ...
            <div className="mt-8 w-full rounded rounded-sm border border-border-primary bg-black text-white">
              <div className="flex flex-col gap-1 border-b border-border-primary p-6">
                ...
                <span className="text-sm font-medium text-text-secondary">
                  View all the transactions organized with account numbers and
                  recording.
                </span>
              </div>
              <div className="p-6">
            ...
            <div className="mt-8 w-full rounded rounded-sm border border-border-primary bg-black text-white">
              <div className="flex flex-col gap-1 border-b border-border-primary p-6">
                ...
                <span className="text-sm font-medium text-text-secondary">
                  The Ledger Book allows you to organize every amount by account
                  number so that it will be easier to see the balance of each
                  for the accounting balance.
                </span>
              </div>
              <div className="p-6">
                    ...
                    [
                      ...
                      <LedgerTable
                        ...
                        transactions={flatRecordings.filter(
                          (transaction) => transaction.accountNumber === item
                        )}
                      />
                    ))}
                </div>
              ...
              <div className="p-6">
                {flatRecordings?.length && (
                  <table className=" w-full bg-black px-6">
                    ...
                    <tbody>
                      {accountingBalanceTable.getRowModel().rows.map((row) => (
                        <tr key={row.id}>
                      ...
                      <tr className="bg-black">
                        ...
                        <td className="border-t border-border-primary p-4">
                          <span className="text-md font-bold uppercase">
                            {flatAccounts
                              .filter(
                                (account) => account.debit >= account.credit
                              )
                              .map((acount) =>
          ...
          <div className="w-full pt-14">
            ...
            <div className="mt-8 w-full rounded rounded-sm border border-border-primary bg-black text-white">
              <div className="flex flex-col gap-1 border-b border-border-primary p-6">
                ...
                <span className="text-sm font-medium text-text-secondary">
                  Income Statement regroups all recordings that are related to
                  income and expenses.
                </span>
              </div>
              <div className="w-full p-6">
                {flatAccounts?.length && (
                  <div className="flex flex-row bg-bg-primary">
                    <div className="flex w-1/2 flex-col rounded-l-md border border-border-primary">
                    ...
                    <div className="flex w-1/2 flex-col rounded-r-md border border-border-primary">
                      <div className="border-b border-border-primary bg-black p-4 text-center text-lg font-bold uppercase">
                        Income
                      </div>
                      <div className="flex flex-col bg-bg-primary py-4 px-6">
            ...
            <div className="mt-8 w-full rounded rounded-sm border border-border-primary bg-black text-white">
              <div className="flex flex-col gap-1 border-b border-border-primary p-6">
                ...
                <span className="text-sm font-medium text-text-secondary">
                  The balance sheet includes every transaction other than income
                  and expenses. If done correctly, total assets should be equal
                ...
                {flatAccounts?.length && (
                  <>
                    ...
                    <div className="bg-primary flex flex-row">
                      <div className="flex w-1/2 flex-row justify-between rounded-b-md border border-border-primary p-5">
                        <span className="text-md font-bold uppercase">
                          Total
                        </span>
                        {flatAccounts
